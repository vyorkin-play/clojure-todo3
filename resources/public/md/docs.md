...
Two middleware functions are provided by default in the `todo.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `todo.handler` namespace to manage the enabled middleware.
